...
# TODO pass the run key as a parameter to disambiguate this
## get_run_features <- function(wildcards, config) {
##     run_key <- wildcards[["run_key"]]
##     config[["ebm_runs"]][[run_key]][["features"]]
## }

## get_run_error_labels <- function(wildcards, config) {
##     run_key <- wildcards[["run_key"]]
##     config[["ebm_runs"]][[run_key]][["error_labels"]]
## }
...
## error_labels <- get_run_error_labels(snakemake@wildcards, snakemake@config)
