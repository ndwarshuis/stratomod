...
## raw_index_col <- fconf[["raw_index"]]
## idx <- fconf[["bed_index"]]

# TODO super wet... (pass all these columns in via python since I don't feel
# like writing the machinary twice
## x_col_types <- if (has_label) {
##                    cols(
##                        !!label_col := "-",
##                        !!raw_index_col := "-",
##                        !!idx[["chr"]] := "-",
